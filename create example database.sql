...
-- (Сreate table employees_49 with the following information)
...
values ('Angelina'), ('Scarlett'), ('Margot'), ('Emma'), ('Jennifer'), ('Gal'), ('Margaret'), ('Dakota'), ('Lupita'), ('Charlize'), ('Emily'), ('Alicia'), ('Emma'), ('Brie'), ('Natalie'), ('Lily'), ('Keira'), ('Olivia'), ('Mila'), ('Rachel'), ('Jessica'), ('Emilia'), ('Julia'), ('Kate'), ('Cate'), ('Saoirse'), ('Jennifer'), ('Anne'), ('Sandra'), ('Reese'), ('Nicole'), ('Amy'), ('Gemma'), ('Tessa'), ('Zoe'), ('Yara'), ('Zendaya'), ('Emma'), ('Chloe'), ('Elle'), ('Dove'), ('Madison'), ('Hailee'), ('Victoria'), ('Bella'), ('Kaley'), ('Anna'), ('Emily'), ('Amber'), ('Megan'), ('Selena'), ('Lindsay'), ('Kristen'), ('Mandy'), ('Ashley'), ('Vanessa'), ('Hilary'), ('Alyssa'), ('Jennifer'), ('Jordana'), ('Rosario'), ('Michelle'), ('Zoe'), ('Jada'), ('Gabrielle'), ('Taraji'), ('Viola'), ('Octavia'), ('Regina'), ('Issa');

-- 3. Создать таблицу salary_49 со следующей инфромацией:
-- (Сreate table salary_49 with the following information)
--	id, serial,  primary key
...
-- (Сreate table employee_salary_49 with the following information)
--	id, serial,  primary key
...
values (66, 7), (15, 1), (68, 2), (54, 2), (46, 1), (13, 7), (60, 9), (9, 9), (1, 16), (33, 14), (43, 5), (61, 15), (52, 14), (24, 11), (63, 2), (36, 4), (10, 12), (50, 13), (44, 4), (37, 1), (19, 1), (70, 5), (4, 9), (23, 6), (29, 10), (11, 10), (35, 3), (62, 5), (16, 8), (45, 2), (95, 15), (72, 3), (97, 3), (74, 11), (79, 10), (71, 7), (87, 10), (93, 11), (85, 2), (81, 1);

-- 7. Создать таблицу roles_49 со следующей инфромацией:
-- (Сreate table roles_49 with the following information)
--	id, serial,  primary key
...
values (4, 20), (20, 9), (8, 9), (2, 2), (32, 19), (9, 12), (22, 19), (6, 20), (14, 20), (30, 14), (27, 19), (15, 1), (26, 17), (36, 19), (31, 1), (7, 3), (18, 11), (23, 14), (37, 7), (12, 12), (39, 18), (38, 10), (13, 12), (34, 5), (33, 13), (21, 4), (29, 12), (25, 10), (19, 11), (40, 9), (5, 10), (28, 15), (35, 2), (24, 20), (1, 14), (17, 3), (3, 9), (16, 9), (11, 18), (10, 17);
